      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <Button variant="outline" onClick={goToPackages} className="gap-2">
              <Plus className="w-4 h-4" />
              Browse Packages
            </Button>
            <Button variant="default" onClick={() => setShowCart(true)} className="gap-2 relative">
                  ...
                  {bookings.map((booking) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-4 text-sm text-foreground truncate max-w-xs">
                          {booking.venue}
                        </td>
                        <td className="p-4 text-sm text-foreground">
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-card w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-xl shadow-2xl flex flex-col">
            ...
            <div className="border-t px-6 py-4 bg-muted/20 flex gap-3">
              ...
              <Button onClick={handleSubmitBooking} className="flex-1" disabled={submitting}>
            ...
            <div className="px-6 md:px-8 py-6 space-y-8">
              ...
              <div className="space-y-4 md:hidden print:hidden">
                {bookingDetailsModal.booking.packages.map((pkg) => (
                  <div key={pkg.packageId[0]} className="border rounded-lg p-4 space-y-1">
                    ...
                    <p className="font-semibold mt-2">{formatPrice(pkg.price || 0)}</p>
                  </div>
                ))}
              </div>
              ...
              {bookingDetailsModal.booking.notes && (
                <div>
                  ...
                  <p className="text-sm text-gray-700">{bookingDetailsModal.booking.notes}</p>
                </div>
              )}
            </div>
