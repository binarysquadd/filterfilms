...
export async function PATCH(
  ...
  try {
    ...
    if (updates.experience !== undefined)
      teamProfileUpdates.experience = updates.experience;
    if (updates.bio !== undefined)
      teamProfileUpdates.bio = updates.bio;
    if (updates.instagram !== undefined)
      teamProfileUpdates.instagram = updates.instagram;
    if (updates.assignment !== undefined)
      teamProfileUpdates.assignment = updates.assignment;
    if (updates.progress !== undefined)
      teamProfileUpdates.progress = updates.progress;
    if (updates.attendance !== undefined)
      teamProfileUpdates.attendance = updates.attendance;
    if (updates.phoneNumber !== undefined)
      teamProfileUpdates.phoneNumber = updates.phoneNumber;
    if (updates.department !== undefined)
      teamProfileUpdates.department = updates.department;
