  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="relative">
        ...
        <div
          className="absolute inset-2 w-16 h-16 border-4 border-transparent border-b-maroon rounded-full animate-spin"
          style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}
        />
        <div
          className="absolute inset-4 w-12 h-12 border-4 border-transparent border-t-gold-light rounded-full animate-spin"
